...
public:
	...
	{ }
	int GetRiskPay() const //SalesWorker 클래스의 ShowSalaryInfo 함수 오버라이딩
	{
	...
	void ShowSalaryInfo() const //SalesWorker 클래스의 ShowSalaryInfo 함수 오버라이딩
	{
		ShowYourName();
		cout<<"salary: "<<SalesWorker::GetPay()<<endl; //SalesWorker의 GetPay 함수가 호출됨
