...
int main_array(void)
{
	...
	*/
	...
	/*for(int i=0; i< sizeof(c_array); i++)
	{
		printf("%d\n", c_array[i]); //ASCII 코드 값 출력(null문자 0으로 입력됨)
	}*/
	...
	//참고: ASCII 코드? ANSI(미국표준협회)에서 제시한 표준코드 체계
	//7bit, 2^7=128개 코드(0~127)
	...
	//참고2: 0~127 사이의 아스키코드 정ㅅ후값에 해당하는 문자 확인
	for(int i=0; i<128; i++)
	{
		printf("아스키콛 정수 %d : %c\n",i,i);
	}
